function [] = outputHighPassInitialWidthWave(conditions,cellData,folderName,givenTitle)
% 各流量条件について最初のdataWidth分の波形の表示を行う. これはハイパスフィルタ用. 
% why needed: ハイパスフィルタにかけるということは低周波数側をカット, つまり定常成分をカットしてしまうということであり, まともに値が残らないため
