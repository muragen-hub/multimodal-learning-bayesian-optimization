function func = nonCorrelationFeatures(moveMaxMinRange)
arguments
...
% wavelet packet analysis 4 level + movRange
    function result = nonCorrelationFeaturesCore(rawData, ~)
        ...
        for idx=1:conditionLength
            ...
            tmp2 = cat(2,WT1,WT2,WT3,WT4,WT5,WT6,WT7,WT8,moveDiffOfMaxMin); %ここ, 行べクトルか列ベクトルかで統一しなかったことの悪い点が出てる. cat(1,~~~)だと同じものを一つのシーケンスにしちゃう.
