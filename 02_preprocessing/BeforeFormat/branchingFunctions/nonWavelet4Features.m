function func = nonWavelet4Features(moveMaxMinRange)
arguments
...
% wavelet packet analysis 4 level + movRange
    function result = nonCorrelationFeaturesCore(rawData, ~)
        ...
        for idx=1:conditionLength
            ...
            tmp2 = cat(2,WT1,moveDiffOfMaxMin,movError,  twoStepError); %ここ, 行べクトルか列ベクトルかで統一しなかったことの悪い点が出てる. cat(1,~~~)だと同じものを一つのシーケンスにしちゃう.
